...
<div class="page-wrapper">
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Currency</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}" class="text-muted">Dashboard</a></li>
                            <li class="breadcrumb-item text-muted active" aria-current="page">Currency</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="card border-primary">
                    <div class="card-header bg-primary">
                        <h4 class="mb-0 text-white">Currency Data</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center"><a href="#modalEdit{{$c->id}}" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modalEdit{{$c->id}}"><i class="fas fa-pencil-alt"></i></a>
                                            <a href="#" data-uri="{{ route('currencies.destroy', $c->id) }}" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modalDestroy"><i class="fas fa-trash-alt"></i></a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                        ...
                        &nbsp; &nbsp;
                        <a href="{{ route('pdfcurrency') }}" class="btn btn-rounded btn-primary" style="color:#fff"><i class="far fa-file-pdf"></i> Export</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="modalEdit{{$c->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form action="{{ route('currencies.update', $c->id) }}" method="POST">
                    @csrf
                    {{ method_field('PUT') }}
                    <div class="modal-content">
                        <div class="modal-header modal-colored-header bg-primary">
                        ...
                        <div class="modal-body">
                            <label>Currency</label>
                            <div class="form-group">
                                <input type="text" name="currency" class="form-control" value="{{ $c->currency }}">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-light" data-dismiss="modal">Close</button>
