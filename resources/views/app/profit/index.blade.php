                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('home') }}" class="text-muted">Dashboard</a></li>
                            <li class="breadcrumb-item text-muted active" aria-current="page">Profit Percentage</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card border-primary">
                    ...
                    <div class="card-body">
                        ...
                        &nbsp; &nbsp;
                        <a href="{{ route('pdfprofit') }}" class="btn btn-rounded btn-primary" style="color:#fff"><i class="far fa-file-pdf"></i> Export</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="modalEdit{{$pft->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form action="{{ route('profit.update', $pft->id) }}" method="POST">
                    ...
                    <div class="modal-content">
                        <div class="modal-header modal-colored-header bg-primary">
                            <h4 class="modal-title" id="primary-header-modalLabel">Edit Profit Percentage
                            </h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>
                        <div class="modal-body">
